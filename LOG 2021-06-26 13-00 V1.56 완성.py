...
def makeGUIFrame(root) :
    ...
    font_4=tkinter.font.Font(family="Helvetica", size=11)#, weight="bold")         # ONAIR
    font_5=tkinter.font.Font(family="Helvetica", size=11)#, weight="bold")         # STDBY
    ...
    tg_ref_list.tag_configure("LINE" , font=font_6, foreground=GR25, background=GR12 )
